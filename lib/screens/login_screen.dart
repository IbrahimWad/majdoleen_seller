...
class _LoginScreenState extends State<LoginScreen> {
    ...
    try {
      ...
      if (accessToken is String && accessToken.isNotEmpty) {
        if (_rememberMe) {
          ...
          // If you prefer "not remember", you can keep it in memory only.
          // For now, we clear saved token.
  ...
  /// ✅ Country picker is now INSIDE the same phone TextFormField
  /// ✅ Always stays on the LEFT even for Arabic/RTL (forced LTR for the field)
